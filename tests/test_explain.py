...
import pytest
from tests._vocabulary import ADVICE, EXECUTION, IDENTITY, MULTI_RUN, spoken
...
#: The lists and the matcher live in `tests/_vocabulary.py`, because `log` is
#: held to the same advice gate (ADR 0020 §5) and a test module importing
#: another makes collection order matter.
